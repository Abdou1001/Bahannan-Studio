...
$(function () {
	...
	$(".topnav .menu-icon").on("click", function () {
		...
		if (open) {
			...
			document.querySelector(".whatappIcon").style.opacity = "0";
		} else {
			...
			document.querySelector(".whatappIcon").style.opacity = "1";
		}
	});
	...
	const filters = document.querySelectorAll(".portfolio .filter-works li");
	const portfolioDivs = document.querySelectorAll(".portfolio .work");

	filters.forEach((li) => {
		li.addEventListener("click", classActive);
	...
	function mangeImgs() {
		portfolioDivs.forEach((img) => (img.style.display = "none"));
